    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <a href="{{route('login')}}" class="logbtn">
                    <li><button id="logInBtn">LOG IN</button></li>
                </a>

                <a href="{{route('dashboard')}}" class="userdashboardbtn">
                    <li><button id="userdashboardbtn">Dashboard</button></li>
                </a>

                @if(Auth::user())
                    <script>document.querySelector(".logbtn").style.display = "none";</script>
                @else
                    <script>document.querySelector(".userdashboardbtn").style.display = "none";</script>
